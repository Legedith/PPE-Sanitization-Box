...
#define FIREBASE_HOST "ppe-reduction.firebaseio.com"                         // the project name address from firebase id
#define FIREBASE_AUTH "4YypjxFOsgh768aV2SHtOPajQr4WWeGsWGM8B9NT"                    // the secret key generated from firebase
#define WIFI_SSID "realme 3a"                                          // input your home or public wifi name 
#define WIFI_PASSWORD "ventriloquista"                                    //password of wifi ssid
